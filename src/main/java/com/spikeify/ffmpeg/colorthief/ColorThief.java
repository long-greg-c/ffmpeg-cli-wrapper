...
import com.spikeify.ffmpeg.colorthief.MMCQ.CMap;
...
public class ColorThief {
	 ...
	 *
	 * @param sourceImage the source image
	 * @return the dominant color as hex tring
	 */
	public static String getDominantHex(BufferedImage sourceImage) {
		int[] rgb = getColor(sourceImage);
		return convertRGBHexString(rgb);
	}
	 ...
	 *                    color.
	 * @param ignoreWhite if <code>true</code>, white pixels are ignored
	 * @return the dominant color as hex String
	 */
	public static String getDominantHex(BufferedImage sourceImage,
	                                     int quality,
	                                     boolean ignoreWhite) {
		int[] rgb = getColor(sourceImage, quality, ignoreWhite);
		return convertRGBHexString(rgb);
	}
